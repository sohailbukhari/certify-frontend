...
export default function ForgotPassword() {
  ...
  const onSubmit = async (values) => {
    try {
      await http.post(
        "https://certify.cyclic.app/users/forgot-password",
        values
      );
  ...
  const onCodeSubmit = async (values) => {
    try {
      const res = await http.post(
        "https://certify.cyclic.app/users/check-reset-code",
        {
          email,
          code: values.code,
        }
  ...
  const onNewPasswordSubmit = async (values) => {
    try {
      await http.post("https://certify.cyclic.app/users/reset-password", {
        ...values,
        email,
        code,
      });
